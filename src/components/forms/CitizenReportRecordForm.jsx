               ...
               <form action="">
                   ...
                   <div className="form-group direccion-rrc">
                    ...
                    <div className="form-group my-3">
                        ...
                        <Popover placement="bottom" isOpen={popoverOpen} target="Popover1" toggle={this.toggle} data-trigger="focus">
                            <PopoverHeader>Reporte</PopoverHeader>
                            <PopoverBody>
                            Si deseas reportar un caso, sin hacer publica tu identidad selecciona la opcion: Reportar Anonimo, en caso contrario pulsa la opcion Compartir Identidad.
                            </PopoverBody>
                        </Popover>
                    </div>
                    ...
                    <div className="form-check form-check-inline">
                        ...
                        />
                        <label className="form-check-label opt-anonimo-rcc" htmlFor="nameless">Reportar Anonimo</label>
                    </div>
                    ...
                    <div className="form-check form-check-inline">
                        <input 
                            ...
                            onChange={this.handleOnchange}
                            />
                        <label className="form-check-label opt-compartir-identidad-rcc" htmlFor="identified">Compartir Identidad</label>
                    </div>
